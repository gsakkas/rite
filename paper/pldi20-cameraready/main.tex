...
\acmConference[PLDI '20]{Proceedings of the 41st ACM SIGPLAN International Conference on Programming Language Design and Implementation}{June 15--20, 2020}{London, United Kingdom}
\acmBooktitle{Proceedings of the 41st ACM SIGPLAN International Conference on Programming Language Design and Implementation (PLDI '20), June 15--20, 2020, London, United Kingdom}
\acmPrice{15.00}
...
%% Title information
\title{Type Error Feedback via Analytic Program Repair}
...
\keywords{Type Error Feedback, Program Synthesis, Program Repair, Machine Learning}  %% \keywords are mandatory in final camera-ready submission
...
\begin{acks}                            %% acks environment is optional
  ...
  %% extraction tools.
  We thank the anonymous referees and our shepherd Ke Wang for their excellent
  suggestions for improving the paper. This work was supported by the
  \grantsponsor{}{NSF}{} grants (\grantnum{}{CCF-1908633},
  \grantnum{}{CCF1763674}) and the \grantsponsor{}{Air Force}{} grants
