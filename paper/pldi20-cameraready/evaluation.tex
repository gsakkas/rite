...
actual fix that are used to synthesize actual repairs.
...
We also compare to a \textit{decision tree} (\trees) and an \svm classifier
trained on the
\SPRING data, since these are two of the most common learning algorithms
\citep{Hastie2009-bn}.
...
(University of California, San Diego and University of Michigan), and from
