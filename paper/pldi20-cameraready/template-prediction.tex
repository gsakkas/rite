...
one joint model is quite intuitive, we found in early experiments
that it does not produce as accurate predictions as the two separate models.
...
predictive models \citep{Allamanis_2017, Bhoopchand_2016}. However, we
found that the BOAT features are essential for high accuracy (see
