...
\paragraph{Clustering the Fixes.} We learn a suitable small set of fix templates by
...
\paragraph{Example.} In \autoref{fig:repair} we can see a minimal repair that our
...
themselves.}.
% However, there are some indications as to what these holes should be.
