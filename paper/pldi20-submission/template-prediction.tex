...
$\labelsym{\Conf}$. \BC{here it's ``a confidence score
$\labelsym{\Conf}$''; just recently it was ``their confidence scores $\Conf$''}
...
feature vector, \ie $\featuresym\ \pbad \mapsto \Emap{\datasym}$ \BC{is this standard?}. We show here
