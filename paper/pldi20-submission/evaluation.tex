...
%
We limit the synthesizer to 90 seconds.
...
times greater than 10 seconds. While the \naive approach is still able
...
templates (\S~\ref{sec:eval:template_quality}).
...
to rate the messages as one of ``Good'', ``Ok'' or ``Bad''.
