...
\mynote{FIXME} For example, in MBD fix is replace |(hd * i)| with candidate expression |[hd * i]|.
...
%
\mynote{FIXME} For example, the candidate expression 
...
% the binary operator, all the rest information is not that important. 
...
\mypara{Clustering the Fixes.} We learn a suitable small 
...
\mypara{Predicting Templates via MCCP}
%
Our
