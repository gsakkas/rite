...
let compareRecWidth l1 l2 = 
  print_endline ((List.length l1));
  print_endline ((List.length l2));
...
(* ###################################################################### *)
(* ################################################################################################## *)
  print_endline (string_of_bool (subtype (RecordT([("1",IntT,Read);("2",IntT,Read)])) (RecordT(["1",IntT,Read]))));
(* ####################################################################################################### *)
  print_endline "Done"
(**)
...
print_endline (type_to_string t11);
print_endline (type_to_string t12);
         if(subtype t2 t11)
         then t12
