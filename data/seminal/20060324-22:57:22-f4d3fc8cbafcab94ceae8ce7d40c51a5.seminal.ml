...
let example_logo_prog = (*[]*)
 ...
 For(10,[]) 
  ...
  (*[makePoly 3 2.0]@[Forward(1.0);Turn(pi /. 2.0);
Forward(2.0);Home;For(100,[Home;Forward(0.0)]);For(5,[Forward(1.0);Turn(pi /.
4.0);Forward(2.0);Home;Forward(1.0)])]*)
