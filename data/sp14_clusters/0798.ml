...
| _ -> (let next =
        ...
        | 6 -> buildSqrt next
        | 7 -> buildGauss (next , next , next))
CaseG VarG [(Nothing,CaseG EmptyG [(Nothing,EmptyG),(Nothing,EmptyG)]),(Nothing,LetG NonRec [EmptyG] EmptyG)]

(35,6)-(47,50)
match rand (1 , 2) with
| 1 -> VarX
| 2 -> VarY
CaseG (AppG [EmptyG]) [(Nothing,ConAppG Nothing Nothing),(Nothing,ConAppG Nothing Nothing)]
